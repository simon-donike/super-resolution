...
class Dataset(Dataset):
    def __init__(self,folder_path,dataset_file,transform="None",sen2_amount=1,sen2_tile="all",location="colab"):
    ...
    def __getitem__(self,idx):
        ...
        while sen2.size()!= torch.Size([3* self.sen2_amount,75,75]) or spot6.size()!=torch.Size([3, 300, 300]) or torch.sum(torch.where(sen2<=0,1,0)) > 1200:
