...
class SRResNet(nn.Module):
    ...
    def __init__(self, large_kernel_size=9, small_kernel_size=3, n_channels=64, n_blocks=16, scaling_factor=4,input_channels=3):
        """
        ...
        # The first convolutional block
        self.conv_block1 = ConvolutionalBlock(in_channels=input_channels, out_channels=n_channels, kernel_size=large_kernel_size,
...
class Generator(nn.Module):
    ...
    def __init__(self, large_kernel_size=9, small_kernel_size=3, n_channels=64, n_blocks=16, scaling_factor=4,input_channels=3):
        ...
        self.net = SRResNet(large_kernel_size=large_kernel_size, small_kernel_size=small_kernel_size,
                            n_channels=n_channels, n_blocks=n_blocks, scaling_factor=scaling_factor,input_channels=input_channels)
