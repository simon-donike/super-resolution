...
def plot_tensors_window(a,b,c,fig_path="show"):
  ...
  window_size = 25
  if b.shape==torch.Size([1, 3, 300, 300]):
    window_size = 100
  ...
  axs[1,1].imshow(b[0:window_size,0:window_size,])
  ...
  if fig_path=="show":
    ...
    plt.savefig(fig_path+dt_string+"_val_PSNR_"+str(metrics[1])+".png",bbox_inches='tight')
